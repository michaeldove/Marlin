...
#define STRING_CONFIG_H_AUTHOR "Michael Dove" // Who made the changes.
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION 250//(X_BED_SIZE - MIN_PROBE_EDGE)
  #define FRONT_PROBE_BED_POSITION 15//MIN_PROBE_EDGE
  #define BACK_PROBE_BED_POSITION 250//(Y_BED_SIZE - MIN_PROBE_EDGE)
